...
import com.example.foodplaner.home.views.HomePageHandler;
...
public class MealsAdapter extends RecyclerView.Adapter<MealsAdapter.ViewHolder> implements MealView {
    ...
    private SearchResultHandler pageHandler;

    public MealsAdapter(Context context, List<Meal> meals, SearchResultHandler pageHandler) {
