...
import com.example.foodplaner.localmeal.presenter.LocalMealPresenter;
import com.example.foodplaner.localmeal.presenter.LocalMealPresenterImp;
import com.example.foodplaner.meal.presenter.MealPresenter;
import com.example.foodplaner.meal.views.IngredientsAdapter;
import com.example.foodplaner.meal.views.MealFragmentArgs;
...
public class LocalMealFragment extends Fragment implements LocalMealView{
    ...
    private LocalMealPresenter presenter;
    private View myView;
    private Meal myMeal;

    public LocalMealFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_local_meal, container, false);
    }
